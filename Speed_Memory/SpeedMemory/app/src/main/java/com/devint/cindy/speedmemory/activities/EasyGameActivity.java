...
import com.devint.cindy.speedmemory.context.Rap;
import com.devint.cindy.speedmemory.context.Score;
import com.devint.cindy.speedmemory.context.Song;
...
public class EasyGameActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int morceau1 = musicStyles.getNextRandomSong();
        int morceau2 = musicStyles.getNextRandomSong();
        int morceau3 = musicStyles.getNextRandomSong();
        ...
        imgList.put(b1.getId(), new Card(b1.getId(), morceau1, b1));
        b2 = (Button) findViewById(R.id.carte2);
        imgList.put(b2.getId(), new Card(b2.getId(), morceau1, b2));
        b3 = (Button) findViewById(R.id.carte3);
        imgList.put(b3.getId(), new Card(b3.getId(), morceau2, b3));
        b4 = (Button) findViewById(R.id.carte4);
        imgList.put(b4.getId(), new Card(b4.getId(), morceau2, b4));
        b5 = (Button) findViewById(R.id.carte5);
        imgList.put(b5.getId(), new Card(b5.getId(), morceau3, b5));
        b6 = (Button) findViewById(R.id.carte6);
        imgList.put(b6.getId(), new Card(b6.getId(), morceau3, b6));

        turnedCards = imgList.size();

        Card.mixCardsEasy(imgList, random);
...
//noinspection SimplifiableIfStatement
    ...
    private class ClickActionListener implements View.OnClickListener {
        ...
        public void showDialogforPseudo() {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(EasyGameActivity.this);
            ...
            alertDialogBuilder
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Score scoreToAdd = new Score(1, ps, sc, ti);
                            MainActivity.db.addScore(scoreToAdd);

                            Intent intent = new Intent(EasyGameActivity.this, FinalActivity.class);
        ...
        private void playSound(int resId) {
            ...
            mPlayer = MediaPlayer.create(EasyGameActivity.this, resId);
            mPlayer.start();
        }
    }
}